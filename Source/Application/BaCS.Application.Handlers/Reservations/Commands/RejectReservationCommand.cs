...
public static class RejectReservationCommand
{
    public record Command(Guid ReservationId, string Reason) : IRequest<ReservationDto>;
    ...
    ) : IRequestHandler<Command, ReservationDto>
    {
        public async Task<ReservationDto> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            await emailNotifier.SendReservationRejected(
                reservation,
